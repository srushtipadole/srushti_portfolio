...
export default function About() {
  ...
  return (
    <main id="about" className="bg-black text-white pt-32 pb-24">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 mb-20 sm:mb-32">
        <div className="flex flex-col lg:flex-row gap-12 lg:gap-20 items-center lg:items-start">
          ...
          {/* LEFT: IMAGE */}
          <div className="flex ml-0 lg:ml-15 justify-center shrink-0">
            <div className="relative group">
              ...
              <img
                ...
                alt="Srushti Padole"
                className="relative w-[290px] h-[380px] md:w-[360px] md:h-[520px]
          ...
          <div className="flex flex-col justify-center gap-10 ml-0 lg:ml-18 w-full">
...
My curiosity extends beyond code. As an avid traveller, I draw inspiration from diverse cultures and perspectives, while singing keeps me expressive and grounded. These experiences shape my approach to building solutions that are not just functional, but truly human-centered — crafted with empathy, clarity, and purpose."
            ...
            {/*
              CLIPPING FIX:
              - overflow-x-auto only on mobile (below lg) for horizontal scroll
              - overflow-visible on lg+ so the HoverCard popup is never clipped
              - SkillHoverCard uses avoidCollisions + z-[9999] + side="top" on mobile
                so the popup always escapes the scroll container
            */}
            <div className="flex gap-4 shrink-0 overflow-x-auto lg:overflow-visible pb-2 lg:pb-0">
              <SkillHoverCard
                label="Confidence"
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-start">
          ...
          <div className="flex flex-col gap-8">
            ...
            {[
              ...
              {
                role: "Women MentHership Program",
              ...
              >
                <div className="flex justify-between items-start flex-wrap gap-2">
                  ...
                  <span className="text-xs px-3 py-1 rounded-full bg-white/10 text-gray-200 shrink-0">
                    {item.tag}
                  </span>
                </div>
                ...
                <button
                  ...
                  className="mt-4 text-sm border border-white/30 px-4 py-1 rounded-full hover:bg-white hover:text-black transition"
                >
                  {item.action}
                </button>
              </div>
          ...
          <div className="flex flex-col">
            <h2 className="text-xl font-bold text-[#d8c195] flex items-center gap-2 pb-8">
            ...
            <div className="rounded-2xl p-8 space-y-6 bg-white/5 border border-white/10">
              <div>
                <div className="flex justify-between flex-wrap gap-2">
                  ...
                  <span className="text-xs bg-black/40 px-3 py-1 rounded-full shrink-0">
                    2022 – 2026
                  </span>
                </div>
                <p className="text-sm text-gray-300">CGPA: 7.2</p>
                <p className="text-sm text-gray-400">
              ...
              <div>
                ...
                <p className="text-sm text-gray-300">Score: 88.5%</p>
                <p className="text-sm text-gray-400">
                  Smt. Nankibai Wadhwani Jr. Science College, Yavatmal
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-sm text-gray-300">Score: 96.8%</p>
                <p className="text-sm text-gray-400">
                  Free Methodist English High School, Yavatmal
                </p>
              </div>
            </div>
            ...
            {/* ================= CERTIFICATES ================= */}
            <div className="mt-20">
              <h3 className="text-xl font-semibold text-white mb-8 tracking-wide">
                📜 Certifications
              </h3>
